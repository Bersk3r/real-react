...
/**간소화된 코드*/
import createItemsLogic from "../common/createItemLogic"; // 공통 로직의 생성자 함수를 가져옴
const  { add, remove, edit, reducer} = createItemsLogic("friends"); // friends라는 이;름으로 공통 로직을 생성함
export const addFriend = add; // 액션 생성자 함수를 원하는 이름으로 변경하여 내보냄
export const removeFriend = remove;
export const editFriend = edit;
export default reducer; // 리듀서 함수를 그대로 내보냄